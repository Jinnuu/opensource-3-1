...
public class WristExerciseActivity extends AppCompatActivity {
    private static final String TAG = "WristExerciseActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wrist_exercise);
    ...
    private void saveWorkoutData() {
        ...
        Workout workout = new Workout("wrist", (int)duration, new Date(), userName);

        String json = gson.toJson(workout);
        Log.d(TAG, "Saving workout data: " + json);
        Log.d(TAG, "API URL: " + Constants.API_WORKOUTS + "?userName=" + userName);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Log.e(TAG, "Failed to save workout data", e);
                runOnUiThread(() -> {
                    Toast.makeText(WristExerciseActivity.this, 
