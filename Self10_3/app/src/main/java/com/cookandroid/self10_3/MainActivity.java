    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnNewActivity.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (rdoGroup.getCheckedRadioButtonId()==R.id.rdoAdd)
                        intent.putExtra("Calc", "+");
                else if(rdoGroup.getCheckedRadioButtonId()== R.id.rdoSub)
                        intent.putExtra("Calc", "-");
                else if(rdoGroup.getCheckedRadioButtonId()== R.id.rdoMul)
                        intent.putExtra("Calc", "*");
                else if(rdoGroup.getCheckedRadioButtonId()== R.id.rdoDiv)
                        intent.putExtra("Calc", "/");
