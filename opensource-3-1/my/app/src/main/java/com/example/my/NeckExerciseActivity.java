...
public class NeckExerciseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neck_exercise);
    ...
    private void saveWorkoutData() {
        ...
        Workout workout = new Workout("neck", (int)duration, new Date(), userName);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> {
                    Toast.makeText(NeckExerciseActivity.this, 
